        ...
        <div class="modal-content">
         ...
         <div class="modal-body">
          <form name="EdCad" id="name" method="post" action="" enctype="multipart/form-data">
           ...
           <div class="col-xs-6 form-group">E-Mail
            <input class="form-control" type="mail" name="ml" required="required">
           </div>
           <div class="col-xs-4 form-group">Telefone
            <input class="form-control" type="mail" name="fone" required="required">
           </div>
           <div class="col-xs-2 form-group">Quantidade
          ...
          <?php
           if(@$_POST["Tsenha"]){
            ...
            $AddCat = $PDO->query("INSERT INTO cadVacinas (NomeContato, NomeVacina, Endereco, DataValidade, EmailOrigem, DataCadastro, NumTelefone) VALUES ('$Nome', '$Vacina', '$Local', '$Data', '$Email', '$DataCad', '$Tel')");
